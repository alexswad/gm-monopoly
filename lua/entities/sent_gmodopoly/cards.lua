ENT.ChanceCards = {
	...
	{"Advance to Go (Collect $200)", go = true, space = 1},
	{"Advance to Illinois Avenue. If you pass Go, collect $200", go = true, space = 25},
	{"Advance to St. Charles Place. If you pass Go, collect $200", go = true, space = 12},
	...
	{"Take a trip to Reading Railroad. If you pass Go, collect $200", go = true, space = 6},
}
